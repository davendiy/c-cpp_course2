...
/* Realisation of big numbers presented like an array of small numbers.
 *
 * It means that BigInteger A = A0 + A1 * 10^k + A2 * 10^2k ... where k - max digits amount
 * of one element. In this realisation k == 9, and each Ai contains as long int number in order to
 * provide the possibility to contain Ai + Aj, Ai * Aj and Ai - Aj (instead intermediate normalizations that
 * raises elapsed time). */
